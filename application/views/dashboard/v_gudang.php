...
<html>
    ...
    <div class="row">            
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-aqua">
          ...
          <a href="<?php echo site_url('gudang/barang') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          ...
          <a href="<?php echo site_url('gudang/supplier') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-yellow">
          ...
          <a href="<?php echo site_url('gudang/kategori'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <section class="col-lg-12 connectedSortable">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs pull-right">
            ...
            <li class="pull-left header"><i class="fa fa-inbox"></i>Grafik Jumlah Barang Masuk</li>
          </ul>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $.ajax({
          url : "<?php echo site_url('dashboard/gudang'); ?>",
          type: "POST",
          data: "",
          dataType: "json",
          cache:false,
